											...
											<div class="col-md-12">
												<div class="form-group">
													<label for="InputText">Advertisement Name</label><input type="text"
														id="InputText" placeholder="Enter text" name="advertisement_Name"
														class="form-control" />
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<textarea rows="4" class="form-control" name="advertisement_Des"></textarea>
													
												</div>
												<div class="form-actions">
												<div class="col-md-offset-3 col-md-9">
												<input type="hidden" name="flag" value="insertAdvertisement">
