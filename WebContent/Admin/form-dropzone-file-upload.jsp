...
<html lang="en">
<head>
<title>Dropzone File Upload | Forms</title>
<meta charset="utf-8">
...
<body class=" ">
				...
				<div class="sidebar-collapse menu-scroll">
					<ul id="side-menu" class="nav">
						...
						<ul class="nav nav-second-level">
								...
								<li class="active"><a href="form-dropzone-file-upload.html"><i
			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<div class="page-header pull-left">
						<div class="page-title">Dropzone File Upload</div>
					</div>
	...
	<script src="js/form-dropzone-file-upload.js"></script>
