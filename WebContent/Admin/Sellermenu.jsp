	...
	<div class="sidebar-collapse menu-scroll">
		<ul id="side-menu" class="nav">
			...
			<li><a href="#"><i class="fa fa-laptop fa-fw"><div
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="#"><i class="fa fa-desktop fa-fw"><div
										class="icon-bg bg-pink"></div></i><span class="menu-title">Post Advertisement</span><span
								class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
								<li><a href="<%=request.getContextPath() %>/PostingController?flag=load"><i
										class="fa fa-align-left"></i><span class="submenu-title">Posting 
											Ads</span></a></li>
								
								<li><a href="<%=request.getContextPath()%>/PostingController?flag=searching"><i
										class="fa fa-align-left"></i><span class="submenu-title">Search 
			...
			<li><a href="#"><i class="fa fa-desktop fa-fw">
				...
				</i> <span class="menu-title">Manage Auction</span> <span
					class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li><a href="<%=request.getContextPath() %>/AuctionController?flag=load"> <i class="fa fa-align-left"></i>
							<span class="submenu-title">Add Auction</span></a></li>
					<li><a href="<%=request.getContextPath()%>/AuctionController?flag=search"> <i
			...
			<li><a href="#"><i class="fa fa-send-o fa-fw"><div
						...
						complaint</span> <span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li><a href="addcomplaint.jsp"><i
			...
			<li><a href="#"><i class="fa fa-rocket fa-fw">
				...
				</i> <span class="menu-title">Manage Feedback</span> <span
					class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li><a href="addfeedback.jsp"> <i class="fa fa-spinner"></i>
							<span class="submenu-title">Add Feedback</span> <span
			...
			<li><a href="#"><i class="fa fa-database fa-fw"><div
							class="icon-bg bg-red"></div></i> <span class="menu-title">Manage Product
						</span><span class="fa arrow"></span> <!-- <span
					class="label label-yellow">
						Hot
				</span> --></a>
				<ul class="nav nav-second-level">
					<li><a href="<%=request.getContextPath() %>/ProductController?flag=load"><i class="fa fa-th-large"></i><span
							class="submenu-title">Add Product</span> <span
							class="fa arrow"></span></a></li>
					<li><a href="<%=request.getContextPath()%>/ProductController?flag=search"><i class="fa fa-tencent-weibo"></i> <span
							class="submenu-title">Search Product</span> <span
							class="fa arrow"></span></a></li>
