			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					...
					<ol class="breadcrumb page-breadcrumb">
						...
						<li><a href="#">Manage Subcategory</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							<div class="portlet box portlet-pink">
								<div class="portlet-header">
									<div class="caption">Subcategory Information</div>
									<div class="tools">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<c:if test="${j.cat_Id eq i.categoryVO.cat_Id}">
													<option value="${j.cat_Id}" selected="selected">${j.cat_Name}</option>
													</c:if>
													<c:if test="${j.cat_Id ne i.categoryVO.cat_Id}">
												...
												<div class="form-group">
													...
													<label for="InputText">Subcategory Name</label><input type="text"
														id="InputText" placeholder="Enter text" name="subcat_Name" value="${i.subcat_Name}"
														class="form-control" />
												...
												<div class="form-group">
													...
													<textarea rows="4" class="form-control" name="subcat_Des">${i.subcat_Des}</textarea>
