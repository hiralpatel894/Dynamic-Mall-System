												...
												<table id="table_id"
													...
													<tbody>
														<c:forEach items="${sessionScope.List}" var="i">
															...
															<c:if test="${x.postingVO.sell_Id eq i.sell_Id }">
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/PostingController?flag=editPost&Id=${i.sell_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<li><a
																			href="${pageContext.request.contextPath}/PostingController?flag=deletePost&id=${i.sell_Id}"><button
																					type="button" class="btn btn-default btn-xs">
