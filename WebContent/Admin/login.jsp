			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					...
					<ol class="breadcrumb page-breadcrumb">
						...
						<li><a href="#">Manage UserName and Password</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
						<li class="active">Add UserName and Password</li>
					</ol>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="InputText">User Name</label><input type="email"
														id="InputText" placeholder="Enter text"
														class="form-control" />
												</div>
												<div class="form-group">
													<label for="InputText">Password</label><input type="password"
														id="InputText" placeholder="Enter text"
														class="form-control" />
												</div>
