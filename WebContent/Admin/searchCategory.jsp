														...
														<c:forEach items="${sessionScope.categoryList}" var="i">
															<tr>
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/CategoryController?flag=editCategory&Id=${i.cat_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<li><a
																			href="${pageContext.request.contextPath}/CategoryController?flag=deleteCategory&Id=${i.cat_Id}"><button
																					type="button" class="btn btn-default btn-xs">
