						...
						<div class="col-lg-12">
							<div class="portlet box portlet-grey">
								...
								<div class="portlet-body">
									<form action="<%=request.getContextPath() %>/SellerRegisController?flag=insert" method="post" role="form" class="form-horizontal form-separated">
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="fn" type="text" name="fname"
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="ln" type="text" name="lname"
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="un" type="text" name="uname"
