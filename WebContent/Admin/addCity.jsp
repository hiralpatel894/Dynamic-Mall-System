						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							<div class="portlet box portlet-pink">
								<div class="portlet-header">
									<div class="caption">City Information</div>
									<div class="tools">
								...
								<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
									<form action="<%=request.getContextPath() %>/CityController?flag=InsertCity" method="post" class="form-validate">
										
										<div class="form-group">
											<label for="dd1" class="control-label">Country</label>
											<select
												id="dd1" name="country_Id" class="form-control required"><option
										...
										<div class="form-group">
											...
											<select id="dd1" name="state_Id" class="form-control required">
										...
										<div class="form-group">
											<label for="" class="control-label">City Name</label><input
												type="text" name="city_Name" class="form-control required" />
										</div>
										
										<div class="form-group">
													<label>City Description</label>
													<textarea rows="4" class="form-control" name="city_Des"></textarea>
												</div>
										
										<button type="submit" class="bt	n btn-success">Submit</button>
										&nbsp;
