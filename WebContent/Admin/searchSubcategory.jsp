														...
														<c:forEach items="${sessionScope.subcategoryList}" var="i">
															<tr>
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/SubcategoryController?flag=editSubcategory&Id=${i.subcat_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<li><a
																			href="${pageContext.request.contextPath}/SubcategoryController?flag=deleteSubcategory&Id=${i.subcat_Id}"><button
																					type="button" class="btn btn-default btn-xs">
