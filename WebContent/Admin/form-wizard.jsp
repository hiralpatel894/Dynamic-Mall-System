...
<body class=" ">
					...
					<ul id="side-menu" class="nav">
						...
						<ul class="nav nav-second-level">
								...
								<li class="active"><a href="form-wizard.html"><i
										class="fa fa-magic"></i><span class="submenu-title">Form
											Wizard</span></a></li>
									...
									<div id="rootwizard-custom-circle">
										...
										<div class="tab-content">
											<div id="tab1-wizard-custom-circle" class="tab-pane">
												...
												<form action="#" class="form-horizontal">
													<div class="form-group">
														<label for="inputUsername" class="col-sm-3 control-label">Username
														...
														<div class="col-sm-9">
															...
															<i class="alert alert-hide">Oops! Forgot something?
																Let try again.</i>
														</div>
													</div>
													<div class="form-group">
														<label for="inputEmail" class="col-sm-3 control-label">Password
															<span class='require'>*</span>
														</label>
														<div class="col-sm-9">
															<div class="input-group">
																<span class="input-group-addon"><i
																	...
																	placeholder="Password" class="inputPwd form-control" />
															</div>
															<i class="alert alert-hide">Oops! Forgot something?
																Let try again.</i>
														</div>
													...
													<div class="form-group">
														<label for="inputAddress" class="col-sm-3 control-label">Password
															confirm <span class='require'>*</span>
														</label>
														<div class="col-sm-9">
															<div class="input-group">
																<span class="input-group-addon"><i
											...
											<div id="tab3-wizard-custom-circle" class="tab-pane fadeIn">
												...
												<form action="#" class="form-horizontal">
													<div class="form-group">
														<label for="inputUsername" class="col-md-2 control-label">Product
															1:</label>
														<div class="col-md-10">
													...
													<div class="form-group">
														<label for="selCountry" class="col-md-2 control-label">Check
															out method</label>
														<div class="col-lg-3 col-md-5">
															<select id="selCountry" class="form-control"><option
																	value="">Cash</option>
																<option value="">Visa Card</option>
																<option value="">Credit Card</option></select>
														</div>
													</div>
												</form>
											</div>
	...
	<script
		src="js/jquery.bootstrap.wizard.min.js"></script>
