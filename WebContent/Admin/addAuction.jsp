						...
						<div class="col-lg-12">
							<div class="portlet box portlet-yellow">
								...
								<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
									<form action="<%=request.getContextPath() %>/AuctionController?flag=insert" method="post" class="form-validate">
										...
										<div class="form-group">
											...
											<input type="textarea" name="product_Desc" class="form-control required" />
										</div>
										...
										<div class="form-group">
											...
											<label for="" class="control-label">Arrival Time</label><input
												type="text" name="arrival_time" class="form-control required" />
										</div>
											
											<div class="form-group">
											<label for="" class="control-label">Departure Time</label><input
												type="text" name="departure_time" class="form-control required" />
										</div>
											...
											<label for="" class="control-label">Minimum Bid Amount </label><input
												type="text" size="12" name="min_bid_amt" class="form-control required" />
										</div>
