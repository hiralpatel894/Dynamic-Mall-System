						...
						<div class="col-lg-12">
							<div class="portlet box portlet-yellow">
								...
								<c:forEach items="${sessionScope.set}" var="k">
									<form action="<%=request.getContextPath() %>/PostingController?flag=update"" method="post" class="form-validate">
										
										<div class="form-group">
										<input type="hidden" value="${k.sell_Id}" name="Id"> 
										...
										<div class="form-group">
											<label for="" class="control-label">Phone</label><input
												type="number" name="phone" value="${k.phone}" class="form-control required" />
										</div>
										...
										<label for="" class="control-label">Ads Description</label>
											<textarea rows="4" name="ads_Desc"
												class="form-control required">${k.ads_Desc}</textarea>
										</div>
										
										<%-- 
										<input type="hidden" name="flag" value="updatePhoto">
										<input type="hidden" name="sellId" value="${k.sell_Id}">
