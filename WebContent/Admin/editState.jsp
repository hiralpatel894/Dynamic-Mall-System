			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<div class="page-header pull-left">
						<div class="page-title">State Name</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="portlet box portlet-yellow">
								...
								<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
									<form action="<%=request.getContextPath() %>/StateController?flag=UpdateState" method="post" class="form-validate">
										<c:forEach items="${sessionScope.state }" var="i">
										<div class="form-group">
											<label for="dd1" class="control-label">Country Name</label><select
												id="dd1" name="country_name" class="form-control required"><option
										...
										<div class="form-group">
											...
											<label for="" class="control-label">State Name</label><input
												type="text" name="state_name" value="${i.state_Name}" class="form-control required" />
										</div>
										
										<div class="form-group">
											<label for="" class="control-label">State Description</label><input
												type="text" name="state_des" value="${i.state_Des}" class="form-control required" />
										</div>
										
										   <input type="hidden" name="flag" value="UpdateState">
											<input type="hidden" name="stateId" value="${i.state_Id}">
