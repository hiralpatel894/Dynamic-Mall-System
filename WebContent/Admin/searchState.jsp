														...
														<c:forEach items="${sessionScope.state}" var="i">
															<tr>
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/StateController?flag=editState&Id=${i.state_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<li><a
																			href="${pageContext.request.contextPath}/StateController?flag=deleteState&Id=${i.state_Id}"><button
																					type="button" class="btn btn-default btn-xs">
