														...
														<c:forEach items="${sessionScope.country}" var="i">
															<tr>
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/CountryController?flag=editCountry&Id=${i.country_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<li><a
																			href="${pageContext.request.contextPath}/CountryController?flag=deleteCountry&Id=${i.country_Id}"><button
																					type="button" class="btn btn-default btn-xs">
