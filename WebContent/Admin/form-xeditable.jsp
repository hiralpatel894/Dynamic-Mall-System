...
<html lang="en">
<head>
<title>Form X-editable | Forms</title>
<meta charset="utf-8">
...
<link type="text/css" rel="stylesheet"
	href="css/select2-madmin.css">
<link type="text/css" rel="stylesheet"
	href="css/bootstrap-datetimepicker.min.css">
<link type="text/css" rel="stylesheet"
	href="css/bootstrap-editable.css">
<link type="text/css" rel="stylesheet"
...
<body class=" ">
				...
				<div class="sidebar-collapse menu-scroll">
					<ul id="side-menu" class="nav">
						...
						<ul class="nav nav-second-level">
								...
								<li class="active"><a href="form-xeditable.html"><i
			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<div class="page-header pull-left">
						<div class="page-title">Form X-editable</div>
					</div>
					<ol class="breadcrumb page-breadcrumb">
						...
						<li><a href="#">Forms</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
						<li class="active">Form X-editable</li>
					</ol>
						...
						<div class="col-lg-12">
							<div class="portlet">
								<div class="portlet-body">
									...
									<div class="mbm">
										<label class="mrxxl"><input id="autoopen"
											type="checkbox" style="vertical-align: baseline;" />&nbsp;
											auto-open next field</label><label class="mrxxl"><input
											id="inline-editing" type="checkbox"
											style="vertical-align: baseline;" />&nbsp; Inline Editing</label><span
											class="mrm">Enable:</span>
									...
									<table id="user" class="table table-bordered table-striped">
										<tbody>
											...
											<tr>
												...
												<td><a id="sex" href="#" data-type="select" data-pk="1"
													data-value="" data-title="Select sex" style="color: gray;"
													class="editable editable-click">not selected</a></td>
											</tr>
											<tr>
												<td>Select, remote array, no buttons</td>
												<td><a id="group" href="#" data-type="select"
													data-pk="1" data-value="5" data-source="/groups"
													data-title="Select group" class="editable editable-click">Admin</a></td>
											</tr>
											<tr>
												<td>Select, error while loading</td>
												<td><a id="status" href="#" data-type="select"
											...
											<tr>
												...
												<td><a id="dob" href="#" data-type="combodate"
											...
											<tr>
												...
												<td><a id="event" href="#" data-type="combodate"
											...
											<tr>
												...
												<td><a id="comments" href="#" data-type="textarea"
											...
											<tr>
												...
												<td><a id="state2" href="#" data-type="typeaheadjs"
													data-pk="1" data-placement="right"
											...
											<tr>
												<td>Checklist</td>
												<td><a id="fruits" href="#" data-type="checklist"
											...
											<tr>
												...
												<td><a id="tags" href="#" data-type="select2"
													data-pk="1" data-title="Enter tags"
													class="editable editable-click">html, javascript</a></td>
											</tr>
											<tr>
												<td>Select2 (dropdown mode)</td>
												<td><a id="country" href="#" data-type="select2"
													data-pk="1" data-value="BS" data-title="Select country"
													class="editable editable-click">Bahamas</a></td>
											</tr>
											<tr>
												<td>Custom input, several fields</td>
												<td><a id="address" href="#" data-type="address"
													data-pk="1" data-title="Please, fill address"
													class="editable editable-click"><b>Moscow</b>, Lenina
														st., bld. 12</a></td>
											</tr>
										</tbody>
									</table>
									<h3>
										Console &nbsp;<small>(all ajax requests here are
											emulated)</small>
									</h3>
									<div>
										<textarea id="console" rows="8" style="width: 70%;"
	...
	<script
		src="js/bootstrap-editable.min.js"></script>
	<script
	...
	<script src="js/form-xeditable.js"></script>
