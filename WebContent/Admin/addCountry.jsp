						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							<div class="portlet box portlet-pink">
								<div class="portlet-header">
									<div class="caption">Country Information</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<form role="form" action="<%=request.getContextPath() %>/CountryController?flag=InsertCountry" method="post">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="InputText">Country Name</label><input type="text" name="country_Name"
														id="InputText" placeholder="Enter text"
														class="form-control" />
												</div>
												<div class="form-group">
													<label>Country Description</label>
													<textarea rows="4" class="form-control" name="country_Des"></textarea>
												</div>
