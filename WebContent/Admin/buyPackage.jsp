			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<div class="page-header pull-left">
						<div class="page-title">Buy Package</div>
					</div>
					<ol class="breadcrumb page-breadcrumb">
						<li><i class="fa fa-home"></i>&nbsp;<a href="index.html">Home</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
						<li><a href="#">Buy Package</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
											</ol>
						...
						<div class="col-lg-12">
							<div class="portlet box portlet-pink">
								<div class="portlet-header">
									<div class="caption">Buy Package</div>
									<div class="tools">
										...
										<div class="row">
											<div class="col-md-4">
												...
												<div class="form-group">
													<label>Type of Package</label><select class="form-control"><option>Option
															1</option>
												...
												<div class="form-group">
													<label>Package Duration</label><select class="form-control"><option>Option
															1</option>
														<option>Option 2</option>
														<option>Option 3</option>
														<option>Option 4</option>
												...
												<div class="form-group">
													<label>Package Price</label><select class="form-control"><option>Option
															1</option>
														<option>Option 2</option>
														<option>Option 3</option>
														<option>Option 4</option>
													...
													<div class="radio mtx">
														<label><input id="optionsRadios2" type="radio"
															name="optionsRadios" value="Visa" />&nbsp; Visa</label>
													</div>
													<div class="radio mtx">
												
														<label><input id="optionsRadios1" type="radio"
															name="optionsRadios" value="Master" checked="checked" />&nbsp;
															Master</label>
													</div>
