										...
										<div class="col-lg-12">
											<div class="table-responsive">
												<table id="table_id"
													...
													<tbody>
														<c:forEach items="${sessionScope.searchpro}" var="i">
															<tr>
																<td>${i.profile_Id}</td>
																<td>${i.countryVO.country_Name}</td>
																<td>${i.stateVO.state_Name}</td>
																<td>${i.cityVO.city_City}</td>
																<td>${i.areaVO.area_Name}</td>
																<td>${i.pin_Code}</td> 
																<td>${i.mobile}</td>
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/ProfileController?flag=editProfile&Id=${i.profile_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<li><a
																			href="${pageContext.request.contextPath}/ProfileController?flag=deleteProfile&Id=${i.profile_Id}"><button
																					type="button" class="btn btn-default btn-xs">
