			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<div class="page-header pull-left">
						<div class="page-title">Manage Advertisement</div>
					</div>
					<ol class="breadcrumb page-breadcrumb">
						<li><i class="fa fa-home"></i>&nbsp;<a href="index.html">Home</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
						<li><a href="#">Manage Advertisement</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							<div class="portlet box portlet-pink">
								<div class="portlet-header">
									<div class="caption">Advertisement Information</div>
									<div class="tools">
								...
								<div class="portlet-body">
									...
									<form role="form" action="<%=request.getContextPath()%>/AdvertisementController" method="post">
										<c:forEach items="${sessionScope.advertisementList}" var="i">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="InputText">Advertisement Name</label><input type="text"
														id="InputText" placeholder="Enter text" name="advertisement_Name" value="${i.advertisement_Name}"
														class="form-control" />
												</div>
												<div class="form-group">
													...
													<c:forEach items="${sessionScope.categoryList}" var="x">
													<c:if test="${x.cat_Id eq i.categoryVO.cat_Id}">
													<option value="${x.cat_Id}" selected="selected">${x.cat_Name}</option>
													</c:if>
													<c:if test="${x.cat_Id ne i.categoryVO.cat_Id}">
												...
												<div class="form-group">
													...
													<option value="">choose one</option>
													<c:forEach items="${sessionScope.subcategoryList}" var="y">
													<c:if test="${y.subcat_Id eq i.subcategoryVO.subcat_Id}">
													<option value="${y.subcat_Id}" selected="selected">${y.subcat_Name}</option>
													</c:if>
													<c:if test="${y.subcat_Id ne i.subcategoryVO.subcat_Id}">
													<option value="${y.subcat_Id}">${y.subcat_Name}</option>
													</c:if>
													</c:forEach>
													</select>
												</div>
												...
												<div class="form-group">
													...
													<textarea rows="4" class="form-control" name="advertisement_Des">${i.advertisement_Des}</textarea>
													
												</div>
												<div class="form-actions">
												<div class="col-md-offset-3 col-md-9">
												<input type="hidden" name="flag" value="updateAdvertisement">
												<input type="hidden" name="advertisement_Id" value="${i.advertisement_Id}">
