...
<html lang="en">
<head>
<title>Feedback Form | Forms</title>
<meta charset="utf-8">
						...
						<div class="col-lg-12">
							<div class="portlet box portlet-pink">
								<div class="portlet-header">
									<div class="caption">Feedback Form</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<form role="form"  action="<%=request.getContextPath()%>/FeedbackController?flag=insert" method="post">
									please tell us what do you thinks Any kind of
										...
										<div class="row">
											...
											<div class="col-md-12">
												...
												<div class="form-group">
													...
													<textarea rows="4" class="form-control" name="feedback_Message"></textarea>
												</div>
