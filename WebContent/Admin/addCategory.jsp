						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							<div class="portlet box portlet-pink">
								...
								<div class="portlet-body">
									<form role="form" action="<%=request.getContextPath()%>/CategoryController?flag=InsertCategory" method="post">
										
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="InputText">Category Name</label><input type="text"
														id="InputText" placeholder="Enter text" name="cat_name" 
														class="form-control" />
												</div>
												<div class="form-group">
													<label>Category Description</label>
													<textarea rows="4" class="form-control" name="cat_des" placeholder="Enter text"></textarea>
												</div>
