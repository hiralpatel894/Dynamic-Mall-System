												...
												<table id="table_id"
													...
													<tbody>
														<c:forEach items="${sessionScope.List}" var="i">
															...
															<c:if test="${x.auctionVO.auction_Id eq i.auction_Id }">
															...
															<c:if test="${y.auctionVO.auction_Id eq i.auction_Id }">
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/AuctionController?flag=edit&Id=${i.auction_Id}"><button
