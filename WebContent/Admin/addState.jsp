			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<div class="page-header pull-left">
						<div class="page-title">State Form</div>
					</div>
					<ol class="breadcrumb page-breadcrumb">
						<li><i class="fa fa-home"></i>&nbsp;<a href="index.html">Home</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
						<li><a href="#">Manage State</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							<div class="portlet box portlet-pink">
								<div class="portlet-header">
									<div class="caption">State Information</div>
									<div class="tools">
								...
								<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
									<form action="<%=request.getContextPath() %>/StateController?flag=InsertState" method="post" class="form-validate">
										
										<div class="form-group">
											<label for="dd1" class="control-label">Country Name</label><select
												id="dd1" name="country_Id" class="form-control required">
										...
										<div class="form-group">
											<label for="" class="control-label">State Name</label><input
												type="text" name="state_Name" class="form-control required" />
										</div>
										
										<div class="form-group">
											<label for="" class="control-label">State Description</label><input
												type="text" name="state_Des" class="form-control required" />
										</div>
