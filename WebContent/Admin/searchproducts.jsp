												...
												<table id="table_id"
													...
													<tbody>
														<c:forEach items="${sessionScope.List}" var="i">
															<tr>
																<td>${i.product_Id}</td>
																<td>${i.categoryVO.cat_Name}</td>
																<td>${i.subcategoryVO.subcat_Name}</td>
																<td>${i.product_Name}</td>
																<td>${i.product_Desc}</td>
															
															<td>
															<c:forEach items="${sessionScope.myList}" var="x">
															<c:if test="${x.productVO.product_Id eq i.product_Id }">
																<img src="<%=request.getContextPath() %>/doc/${x.path}" width="100px" height="100px">
															 </c:if>
															 </c:forEach> 
															 </td>
																<td>${i.product_Brand}</td>
															<td>
															<c:forEach items="${sessionScope.myList}" var="y">
															<c:if test="${y.productVO.product_Id eq i.product_Id }">
																<img src="<%=request.getContextPath() %>/doc/${y.path}" width="100px" height="100px">
															 </c:if>
															 </c:forEach> 
															 </td>
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/ProductController?flag=edit&Id=${i.product_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<%-- <li><a
																			href="${pageContext.request.contextPath}/PostingController?flag=deletePost&id=${i.auction_Id}"><button
																					type="button" class="btn btn-default btn-xs">
