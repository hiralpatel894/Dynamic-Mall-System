			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<div class="page-header pull-left">
						<div class="page-title">Country Form</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="portlet box portlet-yellow">
								<div class="portlet-header">
									<div class="caption">Add Country Name</div>
									<div class="tools">
								...
								<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
									<form action="<%=request.getContextPath() %>/CountryController?flag=UpdateCountry" method="post" class="form-validate">																				
										<c:forEach items="${sessionScope.editcountry }" var= "i">
								
										<div class="form-group">
											<label for="" class="control-label">Country Name</label><input
												type="text" name="add_country" value="${i.country_Name }" class="form-control required" />
										</div>
										<div class="form-group">
													<label>Country Description</label>
													<textarea rows="4" class="form-control" name="country_Des">${i.country_Des }</textarea>
												</div>
										<input type="hidden" name="flag" value="UpdateCountry">
										<input type="hidden" name="countryId" value="${i.country_Id}">
