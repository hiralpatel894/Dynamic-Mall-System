												...
												<table id="table_id"
													...
													<tbody>
														<c:forEach items="${sessionScope.advertisementList}" var="i">
															<tr>
																<td>${i.advertisement_Id}</td>
																<td>${i.advertisement_Name}</td>
																<td>${i.advertisement_Des}</td>
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/AdvertisementController?flag=editAdvertisement&Id=${i.advertisement_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<li><a
																			href="${pageContext.request.contextPath}/AdvertisementController?flag=deleteAdvertisement&Id=${i.advertisement_Id}"><button
																					type="button" class="btn btn-default btn-xs">
