...
<html lang="en">
<head>
<title>Form Layouts | Forms</title>
<meta charset="utf-8">
...
<body class=" ">
			...
			<nav id="sidebar" role="navigation"
				...
				<div class="sidebar-collapse menu-scroll">
					<ul id="side-menu" class="nav">
						...
						<ul class="nav nav-second-level">
								<li class="active"><a href="form-layouts.html"><i
					...
					<div id="form-layouts" class="row">
						<div class="col-lg-12">
							<div class="note note-info">
								...
								<p>Please resize browser to see tab version on Tablet &
									Mobile</p>
							</div>
						</div>
						<div class="col-lg-12">
							<ul class="nav ul-edit nav-tabs responsive">
								<li class="active"><a href="#tab-form-actions"
									data-toggle="tab">Form Actions</a></li>
								<li><a href="#tab-two-columns" data-toggle="tab">2
										Columns</a></li>
								<li><a href="#tab-form-seperated" data-toggle="tab">Form
										Seperated</a></li>
								<li><a href="#tab-form-bordered" data-toggle="tab">Form
										Bordered</a></li>
							</ul>
							<div
								style="background: transparent; border: 0; box-shadow: none !important"
									...
									<div class="row">
														...
														<div class="form-body pal">
															<div class="form-group">
																<label for="inputUsername"
																	class="col-md-3 control-label">Username <span
																	class='require'>*</span></label>
																<div class="col-md-9">
																	<div class="input-icon">
																		<i class="fa fa-user"></i><input id="inputUsername"
										...
										<div class="col-lg-6">
											<div class="panel panel-green">
												<div class="panel-heading">Form Actions On Bottom</div>
												<div class="panel-body pan">
													<form action="#" class="form-horizontal">
														<div class="form-body pal">
															<div class="form-group">
										...
										<div class="col-lg-12">
											<div class="panel panel-blue">
												<div class="panel-heading">Form Actions On Top &
													Bottom</div>
												<div class="panel-body pan">
													<form action="#" class="form-horizontal">
														<div class="form-actions top">
										...
										<div class="col-lg-6">
											<div class="panel panel-yellow">
												<div class="panel-heading">Left Aligned</div>
												<div class="panel-body pan">
													<form action="#">
										...
										<div class="col-lg-6">
											<div class="panel panel-orange">
												<div class="panel-heading">Right Aligned</div>
												<div class="panel-body pan">
													<form action="#">
										...
										<div class="col-lg-12">
											<div class="panel panel-pink">
												<div class="panel-heading">Form Actions Without
													Background</div>
												<div class="panel-body pan">
													<form action="#" class="form-horizontal">
													...
													<form action="#" class="horizontal-form">
														<div class="form-body pal">
																	...
																	<div class="form-group has-error">
																		...
																		<div class="input-icon right">
																			<i data-hover="tooltip"
																				data-original-title="Last Name is empty"
																				class="glyphicon glyphicon-remove tooltips"></i><input
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="selGender" class="control-label">Gender
																			<span class='require'>*</span>
																		</label><select id="selGender" class="form-control"><option
																				value="">Male</option>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputBirthday" class="control-label">Birthday</label><input
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputPhone" class="control-label">Phone</label><input
																...
																<div class="col-md-12">
																	<div class="form-group">
																		<label for="inputStreet" class="control-label">Street
																			<span class='require'>*</span>
																		</label><input id="inputStreet" type="text" placeholder=""
																			class="form-control" />
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputFirstName" class="control-label">District</label><input
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputCity" class="control-label">City
																			<span class='require'>*</span>
																		</label><input id="inputCity" type="text" placeholder=""
																			class="form-control" />
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputPostCode" class="control-label">Post
																			Code</label><input id="inputPostCode" type="text"
																			placeholder="" class="form-control" />
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="selCountry" class="control-label">Country</label><select
																			id="selCountry" class="form-control"><option
													...
													<form action="#" class="form-horizontal">
														<div class="form-body pal">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputFirstName"
																			class="col-md-3 control-label">First Name <span
																			class='require'>*</span></label>
																		<div class="col-md-9">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputLastName"
																			class="col-md-3 control-label">Last Name <span
																			class='require'>*</span></label>
																		<div class="col-md-9">
															...
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9">
																			<select id="selGender" class="form-control"><option
																					value="">Male</option>
																				<option value="">Female</option></select>
																		</div>
																	</div>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9">
																			<input id="inputBirthday" type="text"
																				placeholder="dd/mm/yyyy" class="form-control" />
																		</div>
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9">
																			<input id="inputPhone" type="text" placeholder=""
																				class="form-control" />
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputAddress1"
																			class="col-md-3 control-label">Address 1 <span
																			class='require'>*</span></label>
																		<div class="col-md-9">
																			<input id="inputAddress1" type="text" placeholder=""
																				class="form-control" />
																		</div>
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputAddress2"
																			class="col-md-3 control-label">Address 2</label>
																		<div class="col-md-9">
																			<input id="inputAddress2" type="text" placeholder=""
																				class="form-control" />
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputStates"
																			class="col-md-3 control-label">States</label>
																		<div class="col-md-9">
																			<input id="inputStates" type="text" placeholder=""
																				class="form-control" />
																		</div>
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9">
																			<input id="inputCity" type="text" placeholder=""
																				class="form-control" />
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputPostCode"
																			class="col-md-3 control-label">Post Code</label>
																		<div class="col-md-9">
																			<input id="inputPostCode" type="text" placeholder=""
																				class="form-control" />
																		</div>
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9">
																			<select id="selCountry" class="form-control"><option
																					value="">Select a Country</option>
																				<option value="">United States</option>
																				<option value="">England</option>
																				<option value="">France</option>
														...
														<div class="form-body pal">
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputAddress1"
																			class="col-md-3 control-label">Address 1</label>
																		<div class="col-md-9">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputAddress2"
																			class="col-md-3 control-label">Address 2</label>
																		<div class="col-md-9">
																			<p class="form-control-static">2546 Sunny Branch
																				Manor</p>
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="inputCountry"
																			class="col-md-3 control-label">Country</label>
																		<div class="col-md-9">
									...
									<div class="row">
										<div class="col-lg-12">
													...
													<form action="#" class="form-horizontal form-seperated">
														<div class="form-body">
															<div class="form-group">
																...
																<div class="col-md-4">
																	<input id="inputFirstName" type="text"
																		placeholder="First Name" class="form-control" /><span
															...
															<div class="form-group has-error">
																...
																<div class="col-md-4">
																	<div class="input-icon right">
																		<i class="glyphicon glyphicon-remove"></i><input
																			id="inputLastName" type="text"
																			placeholder="Last Name" class="form-control" />
																	</div>
																	<span class="help-block text-danger">Please
																...
																<div class="col-md-9">
																	<div class="radio">
																		<label class="radio-inline"><input
																			type="radio" value="0" name="gender" />&nbsp; Male</label><label
															...
															<div class="form-group">
																...
																<div class="col-md-4">
																	<div class="input-icon right">
																		<i class="fa fa-mobile-phone"></i><input
																			id="inputPhone" type="text" placeholder=""
																			class="form-control" />
																	</div>
																</div>
															...
															<div class="form-group">
																<label for="inputFirstName"
																	class="col-md-3 control-label">District</label>
																<div class="col-md-4">
																	<input id="inputDistrict" type="text" placeholder=""
																		class="form-control" />
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-md-4">
																	<div class="input-icon right">
																		<i class="fa fa-map-marker"></i><input id="inputCity"
															...
															<div class="form-group">
																<label for="inputPostCode"
																	class="col-md-3 control-label">Post Code <span
																	class='require'>*</span></label>
																<div class="col-md-6">
																	<div class="row">
																		<div class="col-md-2 col-xs-4">
											...
											<div class="panel panel-violet">
												...
												<div class="panel-body pan">
													<form action="#"
														class="form-horizontal form-seperated dashed">
														<div class="form-body">
															<div class="form-group">
																<label for="inputFirstName"
																	class="col-md-3 control-label">First Name <span
											...
											<div class="panel panel-violet">
												...
												<div class="panel-body pan">
													<form action="#"
														class="form-horizontal form-seperated form-row-stripped">
														<div class="form-body">
															<div class="form-group">
																<label for="inputFirstName"
																	class="col-md-3 control-label">First Name <span
									...
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="panel panel-pink">
												...
												<div class="panel-body pan">
													<form action="#"
														class="form-horizontal form-bordered dashed">
														<div class="form-body">
															<div class="form-group">
																<label for="inputFirstName"
																	class="col-md-3 control-label">First Name <span
	...
	<script src="js/ui-generals.js"></script>
