						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							<div class="portlet box portlet-pink">
								<div class="portlet-header">
									<div class="caption">Category Information</div>
									<div class="tools">
								...
								<c:forEach items="${sessionScope.categoryList}" var="i">
									<form role="form" action="<%=request.getContextPath()%>/CategoryController" method="post">
										
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="InputText">Category Name</label><input type="text"
														id="InputText" placeholder="Enter text" name="cat_name" value="${i.cat_Name}"
														class="form-control" />
												</div>
												<div class="form-group">
													<label>Category Description</label>
													<textarea rows="4" class="form-control" name="cat_des">${i.cat_Des}</textarea>
												</div>
											...
											<!-- 	<input type="hidden" name="flag" value="InsertCategory"> -->
												...
												<input type="hidden" name="categoryId" value="${i.cat_Id}">
