					...
					<ul class="nav navbar navbar-top-links navbar-right mbn">
						...
						<li class="dropdown hidden-xs">
							...
							<ul class="dropdown-menu dropdown-theme-setting pull-right">
								<li><h4 class="mtn">Theme Styles</h4> <select
									id="list-style" class="form-control"><option
											value="style1">Flat Squared style</option>
										<option value="style2">Flat Rounded style</option>
										<option value="style3">Flat Border style</option></select></li>
								<li><h4 class="mtn">Menu Styles</h4> <select id="list-menu"
									class="form-control"><option value="sidebar-default">Menu
											style 1</option>
								...
								<li><h4 class="mtn">Header & Sidebar</h4> <select
									id="list-header" class="form-control"><option
							...
							<ul class="nav nav-second-level">
								<li><a href="form-layouts.html"><i
										class="fa fa-columns"></i><span class="submenu-title">Form
											Layouts</span></a></li>
								<li class="active"><a href="form-basic.html"><i
				...
				<div id="chat-box" style="top: 400px">
					...
					<div class="chat-content">
						<ul class="chat-box-body">
							...
							<li class="odd"><p>
									<img
										src="https://s3.amazonaws.com/uifaces/faces/twitter/alagoon/48.jpg"
			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<div class="page-header pull-left">
						<div class="page-title">Basic Forms</div>
					</div>
										...
										<div class="form-body pal">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<span class="help-block mbn"><a href="#"><small>Forgot
											...
											<div class="form-group mbn">
												<div class="col-md-offset-3 col-md-6">
													<div class="checkbox">
														<label><input tabindex="5" type="checkbox" />&nbsp;
									...
									<form action="#">
										<div class="form-body pal">
											...
											<div class="form-group">
												...
												<div class="input-icon right">
													<i class="fa fa-tag"></i><input id="inputSubject"
														type="text" placeholder="" class="form-control" />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group mbn">
												<div class="checkbox">
													<label><input tabindex="5" type="checkbox" />&nbsp;
														Send a copy to my e-mail address</label>
												</div>
											</div>
										</div>
									...
									<form action="#">
										<div class="form-body pal">
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<div class="input-icon">
															<i class="fa fa-envelope"></i><input id="inputEmail"
																type="text" placeholder="E-mail" class="form-control" />
														</div>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<div class="input-icon">
															<i class="fa fa-phone"></i><input id="inputPhone"
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														<input id="inputPostCode" type="text"
											...
											<div class="form-group">
												<textarea rows="8" placeholder="Additional info"
													class="form-control"></textarea>
											</div>
											<hr />
											<div class="form-group">
												<div class="radio">
													<label class="radio-inline"><input id="optionsVisa"
														type="radio" name="optionsRadios" value="Visa"
														checked="checked" />&nbsp; Visa</label><label
														class="radio-inline"><input id="optionsMasterCard"
														type="radio" name="optionsRadios" value="MasterCard" />&nbsp;
														MasterCard</label><label class="radio-inline"><input
														id="optionsPayPal" type="radio" name="optionsRadios"
														value="PayPal" />&nbsp; PayPal</label>
												</div>
											</div>
											<div class="form-group">
												<input id="inputNameCard" type="text"
													placeholder="Name on card" class="form-control" />
											</div>
											<div class="row">
												<div class="col-md-9">
													<div class="form-group">
														<input id="inputCardNumber" type="text"
															placeholder="Card number" class="form-control" />
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
														<input id="inputCVV2" type="text" placeholder="CVV2"
															class="form-control" />
													</div>
												</div>
											</div>
											<div class="row">
												...
												<div class="col-md-3">
													<div class="form-group mbn">
														<input id="inputYear" type="text" placeholder="Year"
															class="form-control" />
													</div>
												</div>
											</div>
								...
								<div class="panel-body pan">
									<form action="#">
										<div class="form-body pal">
											...
											<div class="form-group">
												<div class="input-icon right">
													<i class="fa fa-lock"></i><input id="inputConfirmPassword"
											...
											<div class="form-group">
												<select class="form-control"><option>Gender</option>
									...
									<form action="#">
										<div class="form-body pal">
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<div class="input-icon right">
															<i class="fa fa-globe"></i><input id="inputWebsite"
																type="text" placeholder="" class="form-control" />
														</div>
													</div>
												</div>
											...
											<div class="form-group">
												...
												<textarea rows="5" class="form-control"></textarea>
												<small class="help-block">You may use these HTML
											...
											<div class="form-group mbn">
												<label for="inputSubject" class="control-label">Enter
													characters below</label>
												<div class="input-icon right">
													<i class="fa fa-font"></i><input id="inputSubject"
														type="text" placeholder="" class="form-control" />
												</div>
											</div>
										</div>
										...
										<div class="form-body pal">
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<div class="input-icon right">
															<i class="fa fa-briefcase"></i><input id="inputCompany"
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<select class="form-control"><option>Interested
																in</option>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<div class="input-icon right">
															<i class="fa fa-calendar"></i><input id="inputStartDate"
																type="text" placeholder="Expected start date"
																class="form-control" />
														</div>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<div class="input-icon right">
															<i class="fa fa-calendar"></i><input id="inputFinishDate"
																type="text" placeholder="Expected finish date"
																class="form-control" />
														</div>
													</div>
												</div>
											...
											<div class="form-group">
												<input id="inputIncludeFile" type="file"
									...
									<form action="#">
										<div class="form-body pal">
											...
											<div class="form-group">
												<div class="input-icon right">
													<i class="fa fa-envelope"></i><input id="inputEmail"
														type="text" placeholder="Your e-mail" class="form-control" />
												</div>
											</div>
											<div class="form-group">
												<textarea rows="5" placeholder="Text of the review"
													class="form-control"></textarea>
											</div>
											<div class="form-group">
												<div class="rating">
													<label for="quality-5"><i class="fa fa-star"></i></label><label
														for="quality-4"><i class="fa fa-star"></i></label><label
														for="quality-3"><i class="fa fa-star"></i></label><label
														for="quality-2"><i class="fa fa-star text-yellow"></i></label><label
														for="quality-1"><i class="fa fa-star text-yellow"></i></label>Quality
													of the product
												</div>
											</div>
											<div class="form-group">
												<div class="rating">
													<label for="reliability-5"><i class="fa fa-star"></i></label><label
														for="reliability-4"><i
														class="fa fa-star text-yellow"></i></label><label
														for="reliability-3"><i
														class="fa fa-star text-yellow"></i></label><label
														for="reliability-2"><i
														class="fa fa-star text-yellow"></i></label><label
														for="reliability-1"><i
														class="fa fa-star text-yellow"></i></label>Reliability of the
													product
												</div>
											</div>
											<div class="form-group mbn">
												<div class="rating">
													<label for="overall-5"><i class="fa fa-star"></i></label><label
														for="overall-4"><i class="fa fa-star"></i></label><label
														for="overall-3"><i class="fa fa-star text-yellow"></i></label><label
														for="overall-2"><i class="fa fa-star text-yellow"></i></label><label
														for="overall-1"><i class="fa fa-star text-yellow"></i></label>Overall
													rating
												</div>
											</div>
										</div>
