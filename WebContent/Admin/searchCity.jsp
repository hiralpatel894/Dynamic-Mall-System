														...
														<c:forEach items="${sessionScope.city}" var="i">
															<tr>
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/CityController?flag=editCity&Id=${i.city_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<li><a
																			href="${pageContext.request.contextPath}/CityController?flag=deleteCity&Id=${i.city_Id}"><button
																					type="button" class="btn btn-default btn-xs">
