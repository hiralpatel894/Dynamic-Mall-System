...
<script>
	...
	function selectDuration()
	{
		...
		var aDuration=document.packageForm.package_Duration.options;
		
		for(i=0 ; i<aDuration.length ; i++)
		{
			if(aDuration[i].value == eDuration.value)
			{	
				aDuration[i].selected="selected";
			}
		}
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							<div class="portlet box portlet-pink">
								...
								<div class="portlet-body">
									...
									<form role="form" action="<%=request.getContextPath()%>/PackageController" name="packageForm" method="post">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="InputText">Package Name</label><input type="text"
														id="InputText" placeholder="Enter text" name="package_Name" value="${i.package_Name}"
														class="form-control"/>
												</div>
												<div class="form-group">
													<label for="InputText">Package Description</label><input type="text" 
														id="InputText" placeholder="Enter text" name="package_Des" value="${i.package_Des}"
														class="form-control" />
												</div>
												<div class="form-group">
													...
													<input type="hidden" id="duration" value="${i.package_Duration}">
												</div>
												<div class="form-group">
													<label for="InputText">Package Price</label><input type="text"
														id="InputText" placeholder="Enter text" name="package_Price" value="${i.package_Price}"
														class="form-control" />
												</div>
												...
												<input type="hidden" name="packageId" value="${i.package_Id}">	
