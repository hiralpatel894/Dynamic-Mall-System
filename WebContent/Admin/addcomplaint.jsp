...
<html lang="en">
<head>
<title>Complaint Form | Forms</title>
<meta charset="utf-8">
...
<body class=" ">
	<div>
		...
		<div id="wrapper">
			<!--BEGIN SIDEBAR MENU-->
			<jsp:include page="Sellermenu.jsp"></jsp:include>			<!--END SIDEBAR MENU-->
			<!--BEGIN CHAT FORM-->
						...
						<div class="col-lg-12">
							<div class="portlet box portlet-pink">
								<div class="portlet-header">
									<div class="caption">complaint Form</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<form role="form" action="<%=request.getContextPath()%>/ComplaintController?flag=insert" method="post">
									
									Give your honest opinion of what you think
								 		<div class="row">
											...
											<div class="col-md-12">
												...
												<div class="form-group">
													...
													<textarea rows="1" class="form-control" name="complaint_Subject"></textarea>
												</div>
												</div>
												...
												|
													...
													<textarea rows="4" class="form-control" name="complaint_Message"></textarea>
												</div>
