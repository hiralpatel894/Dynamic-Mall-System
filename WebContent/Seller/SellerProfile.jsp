						...
						<div class="col-lg-12">
							<div class="portlet box portlet-yellow">
								...
								<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
									<form action="<%=request.getContextPath() %>/ProfileController?flag=insertprofile" method="post" class="form-validate">
										...
										<div class="form-group">
											...
											<option value="${i.city_Id}">${i.city_City}</option>											
						  					</c:forEach>	
										...
										<div class="form-group">
											...
											<label for="" class="control-label">Pin code</label><input
												type="number" name="pincode" class="form-control required" />
										</div>
											...
											<label for="" class="control-label">Mobile number </label><input
												type="number" size="12" name="mobile" class="form-control required" />
										</div>
