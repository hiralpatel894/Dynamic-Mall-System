								...
								<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
									<form action= method="post" class="form-validate">
										...
										<div class="form-group">
											<label for="" class="control-label">Seller Name</label><input
												type="text" name="seller name" class="form-control required" />
										</div>
										
										<div class="form-group">
											<label for="" class="control-label">Seller Id</label><input
												type="text" name="seller id" class="form-control required" />
										</div>
										
										
										<div class="form-group">
											<label for="" class="control-label">Shop Name</label><input
												type="text" name="shop name" class="form-control required" />
										</div>
										
										
											
											<div class="form-group">
											<label for="" class="control-label">Seller email</label><input
												type="email" name="seller email" class="form-control required" />
										</div>
										...
										<div class="form-group">
											...
											<div class="form-group">
											<label for="" class="control-label">Photo upload </label><input
												type="file"  name="photo upload" class="form-control required" />
										</div>
										
										
										<div class="form-group">
										<label for="" class="control-label">Ads Description</label>
											<textarea rows="4" name="ads description"
