...
<!--Loading style-->
<link type="text/css" rel="stylesheet"
	href="css/style1/orange-blue.css" class="default-style">
<link type="text/css" rel="stylesheet"
			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<div class="page-header pull-left">
						<div class="page-title">Seller Register</div>
					</div>
					<ol class="breadcrumb page-breadcrumb">
						...
						<li><a href="#">Seller</a>&nbsp;&nbsp;<i
							class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
						<li class="active"> Seller Register</li>
					</ol>
						...
						<div class="col-lg-12">
							<div class="portlet box portlet-grey">
								<div class="portlet-header">
									<div class="caption">Seller Registration</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<form action="<%=request.getContextPath() %>/SellerRegisController?flag=update" method="post" role="form" class="form-horizontal form-separated">
									<c:forEach items="${sessionScope.edit }" var="i">
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="fn" type="text" name="fname" value="${i.f_Name }"
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="ln" type="text" name="lname" value="${i.l_Name }"
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="un" type="text" name="uname" value="${i.u_Name }"
											...
											<div class="form-group">
													...
													<div class="col-md-9">
														<input type="email"
															placeholder="Email Address" class="form-control" name="email"  value="${i.email}" />
													</div>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="message1" type="password" name="password"
													placeholder="password"	value="${i.pass}" class="form-control" />
																									</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="message1" type="password" name="repassword"
													 placeholder="retype password" value="${i.repass }" class="form-control" />
																									</div>
											</div>
