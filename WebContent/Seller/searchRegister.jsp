										...
										<div class="col-lg-12">
											<div class="table-responsive">
												<table id="table_id"
													...
													<tbody>
														<c:forEach items="${sessionScope.regis}" var="i">
															<tr>
																<td>${i.reg_Id}</td>
																<td>${i.f_Name}</td>
																<td>${i.l_Name}</td>
																...
																<td>
																	<ul>
																		<li><a
																			href="${pageContext.request.contextPath}/SellerRegisController?flag=editRegis&Id=${i.reg_Id}"><button
																					type="button" class="btn btn-default btn-xs">
																					<i class="fa fa-edit"></i>&nbsp; Edit
																				</button></a></li>
																		<li><a
																			href="${pageContext.request.contextPath}/SellerRegisController?flag=deleteRegis&Id=${i.reg_Id}"><button
																					type="button" class="btn btn-default btn-xs">
