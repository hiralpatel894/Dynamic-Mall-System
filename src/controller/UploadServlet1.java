...
public class UploadServlet1 extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, 
      ...
      // Check that we have a file upload request
	   ...
	   session1.setAttribute("url1", path1);
      ...
      while ( i.hasNext () ) 
      {
         ...
         if ( !fi.isFormField () )	
         {
            ...
            myFileList = (List) session.getAttribute("fileList1");
            ...
            session.setAttribute("fileList1", myFileList);
      ...
      /*Begin*/
      HttpSession session = request.getSession();
      List myFileList = (List) session.getAttribute("fileList1");
